...
JAXnet makes things like variational inference or L2 regularization of whole networks concise (see [API](API.md#regularization-and-reparametrization)).
...
Here is a crude comparison of some popular deep learning libraries:
